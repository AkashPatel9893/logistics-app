...
| `npx --yes eas-cli@latest simulator:get [--id <id>] [--json] [--non-interactive]`                 | Session status + connection details, including the session name. **Use this to confirm readiness** (see _Operating principles_).                                                                                                                           |
